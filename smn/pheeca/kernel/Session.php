...
use \smn\pheeca\kernel\Session\FilesHandler;
use \smn\pheeca\kernel\Session\Exception;
use \ReflectionClass;
...
class Session {
    ...
    public static function start($handler = null, $dataManipulation = null, $options = array()) {
        return new self($handler, $dataManipulation, $options);
    }
    ...
    /**
     * 
     * @return \smn\pheeca\kernel\Session\SessionInterface
     */
    ...
    /**
     * 
     * @return \smn\pheeca\kernel\Session\StorageInterface
     */
