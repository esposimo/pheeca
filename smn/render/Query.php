...
class render_Query {
    ...
    public function __construct($data = '*', $document = null) {
        ...
        if (is_string($data)) {
            $selector = render_Query::css2xpath($data);
     ...
     * @param type $selector
     * @param type $document
     * @return render_Element|render_Collect
     */
    ...
    private function getElements() {
        ...
        if ($this->_elementList->length == 1) {
            ...
            return render_Element::createRenderElement($element);
        }
        return new render_Collect($this->_elementList);
    }
