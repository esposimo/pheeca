...
class render_Element {
    ...
    public static function createRenderElement($element) {
        $self = new render_Element($element);
        return $self;
    }
    ...
    public function __construct($name, $value = null, $namespaceURI = null, $parentDocument = null, $children = null, $attributes = null, $classes = null, $styles = null) {
        ...
        if ($name instanceof render_Element) {
        ...
        if (!is_null($parentDocument)) {
            ...
            if ($parentDocument instanceof render_Element) {
            ...
            if (is_string($parentDocument)) {
                ...
                $csstoxpath = render_Query::css2xpath($parentDocument);
    ...
    public function addChildren($child) {
        if (is_array($child)) {
            foreach ($child as $element) {
                ...
                if ($element instanceof render_Element) {
            ...
            if ($child instanceof render_Element) {
